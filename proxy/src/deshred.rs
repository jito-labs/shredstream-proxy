...
use jito_protos::deshred::{DeshredRequest, Entry as DeshredEntry};
use jito_protos::deshred::deshred_service_server::{DeshredService, DeshredServiceServer}; 
...
pub fn insert_packet_into_shred_bucket(packet: &Packet, shred_bucket_by_slot:  &Arc<RwLock<HashMap<Slot, BTreeSet<WrappedShred>>>>, entry_sender: &Arc<Sender<DeshredEntry>>) {
